  ...
  return (
    ...
    <div className="flex justify-between items-center pt-8 mb-12 max-md:mb-6 max-md:block">
        <div className="title flex justify-between w-full max-[426px]:items-center">     
            <a href="/">
            <h1 className={`text-3xl max-md:text-xl italic font-bold signature`} onClick={() => handleLinkClick(0)}>&lt;Manvi Gupta /&gt;</h1>
            </a>     
        ...
        <nav className={`flex gap-10 max-md:flex-col max-md:mt-12 ${menuOpen ? "max-md:flex" : "max-md:hidden"} `}>
          ...
          <ul className={`hidden justify-around items-center mt-28 max-md:flex`}>
            <li><a href="https://github.com/pythoncoder08765" className="text-4xl" target="_blank" rel="noreferrer"><FaGithub /></a></li>
            <li><a href="https://www.linkedin.com/in/gmanvi?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="text-4xl" target="_blank" rel="noreferrer"><FaLinkedin /></a></li>
          </ul>
      </nav>  
